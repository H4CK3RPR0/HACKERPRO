...
{red}
 ...
 |  __  |   / /\ \   | |      |  <   |  __|   |  _  /  |  ___/  |  _  /  | |  | |
 | |  | |  / ____ \  | |____  | . \  | |____  | | \ \  | |      | | \ \  | |__| |
 |_|  |_| /_/    \_\  \_____| |_|\_\ |______| |_|  \_\ |_|      |_|  \_\  \____/ {purple}H4CK3RPR0
...
==============================================={nc}''')
  ...
  def not_ins(self):
    self.tool_header()
    print (f'''
{cyan}  [ + ]  {red}We can't install HACKERPRO.
...
{yellow}    [ + ] {green}Type Tool-X in your terminal.''')
  ...
  def update(self):
    self.tool_header()
    print (f'''
{yellow}  [ 1 ] {green}Update your HACKERPRO.
{yellow}  [ 0 ] {green}For Back.{nc}''')
  ...
  def updated(self):
    self.tool_header()
    print (f'''
{yellow}      [ + ] {green}HACKERPRO Updated Successfully.
...
{cyan}  [ + ]  {red}Please try again after some time.{nc}''')
  ...
  def update_error(self):
    self.tool_header()
    print (f'''
{red}  [ + ]  {red}We can't Update HACKERPRO.\033[1;m
{red}  [ + ]  {red}Please try again after some time.{nc}''')
  ...
  def about(self,total):
    self.tool_header()
    print (f'''
{yellow}       [+] Tool Name :- {green}HACKERPRO
...
{yellow}  [ 3 ] {green}Update HACKERPRO.
...
{yellow}  [ x ] {green}For Exit.''')
  ...
  def exit(self):
    self.tool_header()
    print (f'''
{yellow}         [ + ] {green}Thanks for using HACKERPRO
