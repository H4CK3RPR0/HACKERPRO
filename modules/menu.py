        ...
        try:
          if int(cmd) in range(1,int(total)+1):
            while True:
              ...
              print(f"")
              logo.back()
              tcmd=input(f"{blue}HACKERPRO{nc}@{blue}space {yellow}$ {nc}")
    ...
    while True:
      ...
      if cmd=="1":
        ...
        if system.connection():
          ...
          logo.updating()
          if system.sudo != None:
            if os.path.exists(system.home+"/HACKERPRO"):
              pass
            else:
              os.system(system.sudo+" git clone https://github.com/H4CK3RPR0/HACKERPRO.git "+system.home+"/HACKERPRO")
            if os.path.exists(system.home+"/HACKERPRO/install.aex"):
              os.system("cd "+system.home+"/HACKERPRO && "+system.sudo+" sh install.aex")
            ...
            if os.path.exists(system.home+"/HACKERPRO"):
              ...
              os.system("git clone https://github.com/H4CK3RPR0/HACKERPRO.git "+system.home+"/HACKERPRO")
            if os.path.exists(system.home+"/HACKERPRO/install.aex"):
              os.system("cd "+system.home+"/HACKERPRO && sh install.aex")
              if os.path.exists(system.bin+"/HACKERPRO") and os.path.exists(system.conf_dir+"/HACKERPRO"):
                os.system("clear")
                logo.updated()
                cmd=input(f"{blue}HACKERPRO{nc}@{blue}space {yellow}$ {nc}")
  ...
  def menu(self):
    while True:
      ...
      if cmd == "1":
        ...
        logo.exit()
        break
      elif cmd=="rm -t" or cmd=="rm -T" or cmd=="uninstall HACKERPRO" or cmd=="unistall HACKERPRO":
        system=sys()
        if system.sudo:
          os.system(system.sudo+" rm -rf "+system.bin+"/HACKERPRO")
          os.system(system.sudo+" rm -rf "+system.bin+"/HACKERPRO")
          os.system(system.sudo+" rm -rf "+system.conf_dir+"/HACKERPRO")
        else:
          os.system("rm -rf "+system.bin+"/HACKERPRO")
          os.system("rm -rf "+system.bin+"/HACKERPRO")
          os.system("rm -rf "+system.conf_dir+"/HACKERPRO")
        os.system("clear")
        logo.exit()
        break
      else:
...
class tools:
  ...
  def __init__(self):
    system=sys()
    with open(system.conf_dir+"/HACKERPRO/core/data.json") as data_file:
      self.data=json.load(data_file)
    with open(system.conf_dir+"/HACKERPRO/core/cat.json") as cat_file:
